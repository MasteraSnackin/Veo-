  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh-dark': 'radial-gradient(at 40% 20%, hsla(228, 77%, 10%, 1) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(253, 16%, 7%, 1) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(339, 49%, 30%, 1) 0px, transparent 50%), radial-gradient(at 80% 50%, hsla(242, 35%, 25%, 1) 0px, transparent 50%), radial-gradient(at 0% 100%, hsla(343, 68%, 15%, 1) 0px, transparent 50%), radial-gradient(at 80% 100%, hsla(242, 33%, 20%, 1) 0px, transparent 50%)',
      },
      backdropBlur: {
        xs: '2px',
      },
